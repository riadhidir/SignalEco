...
const CollectionPointEdit = () => {
  ...
  const collectionPointId = params.id;
  ...
  const {
    ...
    isError,
    refetch,
    //FIXME:typing issue (params Id might be undefined)
    //@ts-ignore
  ...
  useEffect(() => {
    if (collectionPoint) {
      reset({
        ...
        latitude: parseFloat(collectionPoint.latitude),
        longitude: parseFloat(collectionPoint.longitude),
        photo: collectionPoint.photo || "",
      });
